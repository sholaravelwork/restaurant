...
<body>
    ...
    <div class="login">
        <h1>予約追加画面</h1>
        <div class="container">
            <p><a href="/manage-reserve">[戻る]</a></p>
            <div id="text"></div>
            <form action="{{ route('reserve.store') }}" method="post" id="form-area">
                @csrf
                ...
                <div class="form-group"> <label>
                        電話番号：
                        <input type="text" name="phonenumber" value="{{ old('phonenumber') }}" placeholder="0901234567">
                    </label>
                    @error('phonenumber')
                    <div class="error">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-button">
                    <input type="submit" name="" id="target" value="送信">
                </div>
            </form>
